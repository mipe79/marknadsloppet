...
mysql_query("INSERT INTO $anmalda (loparid, fnamn, enamn, adress, postnummer, ort, land, forening, fodelse, klass, lag_forening, avgift, starttid, antal, epost, betalt, datum, tid) VALUES ('$id1', '$fnamn1', '$enamn1', '$adress', '$postnummer', '$ort', '$land', '$forening', '$fodelse1', '$klass1', '$lag_forening', '$avgift', '$starttid1', '$antal1', '$epost', 'nej', NOW(), NOW())");

sleep(1);

mysql_query("INSERT INTO $anmalda (loparid, fnamn, enamn, adress, postnummer, ort, land, forening, fodelse, klass, lag_forening, avgift, starttid, antal, epost, betalt, datum, tid) VALUES ('$id2', '$fnamn2', '$enamn2', '$adress', '$postnummer', '$ort', '$land', '$forening', '$fodelse2', '$klass2', '$lag_forening', '$avgift', '$starttid2', '$antal2', '$epost', 'nej', NOW(), NOW())");

sleep(1);

mysql_query("INSERT INTO $anmalda (loparid, fnamn, enamn, adress, postnummer, ort, land, forening, fodelse, klass, lag_forening, avgift, starttid, antal, epost, betalt, datum, tid) VALUES ('$id3', '$fnamn3', '$enamn3', '$adress', '$postnummer', '$ort', '$land', '$forening', '$fodelse3', '$klass3', '$lag_forening', '$avgift', '$starttid3', '$antal3', '$epost', 'nej', NOW(), NOW())"); 
  
echo?> <font color="red" face="Verdana, Arial, Helvetica, sans-serif" size="4"><b>Vi har mottagit er anmälan och skickat ett mail med dina uppgifter!!</br></font>
...
<tr>
  <td>
    ...
    <br>
    <br>
    Vi har mottagit din anmälan där ni uppgav följande uppgifter:
    <br>
    <br>
    <hr>
    ...
    <br>
    <br>
    Lagnamn: <b>{$_POST['lag_forening']}</b>\r\n
    <br>
    <br>
    Betalningen gör ni genom att sätta in <b>{$_POST['avgift']} kr</b> på pg nr: <b>162 78 46-7</b> senast <b>{$datum_betalt}.</b>\r\n
...
$headers .= "Bcc: webmaster@marknadsloppet.nu\r\n";
...
<form ACTION="<?=$PHP_SELF ?>" METHOD="post" id=form1 name=form1>
<table WIDTH="550" CELLSPACING="0" CELLPADDING="0" BORDER="0">
<tr height="30">
</tr>	
<tr>
  <td WIDTH="340">
    <font face="Verdana, Arial, Helvetica, sans-serif" size="4"><b>Föreningskampen:</b></font>
   <br>
   <br>
  </td>	
</tr>
...
<tr>
  <td colspan ="5">
    <font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>
     ...
     <br>
     <br>
     Föreningar som registrerar flera lag trycker på "Registrera fler lag många" för samtliga (även för det sista laget)  och trycker därefter "Avsluta" när man är klar.
     <br>
     <br>
...
<tr>
  <td WIDTH="340">
    ...
    <tr>
      ...
      <td><input TYPE="Text" NAME="lag_forening" SIZE="30" MAXLENGTH="30" VALUE="">*</td>
    </tr>
...
<tr>
      <td colspan="2"><b>Glöm ej att tryck på Registrera, även för ditt sista lag!</b></td>
   </tr>
<tr>
      <td colspan="2"><hr></td>
   </tr>
