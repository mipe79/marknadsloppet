...
<p><a href="visa_anmalda.php">&#171 Tillbaka</a>
...
mysql_query("UPDATE $anmalda SET startnr = '{$_POST['startnummer']}', fnamn = '{$_POST['fnamn']}', enamn = '{$_POST['enamn']}', 
 adress = '{$_POST['adress']}', postnummer = '{$_POST['postnummer']}', 
 ort = '{$_POST['ort']}',  
 land = '{$_POST['land']}', adresstyp = '{$_POST['adresstyp']}', forening = '{$_POST['forening']}', 
 ansluten = '{$_POST['ansluten']}', klass = '{$_POST['klass']}', avgift = '{$_POST['avgift']}', starttid = '{$_POST['starttid']}', diplom = '{$_POST['diplom']}', 
 antal = '{$_POST['antal']}', fodelse = '{$_POST['fodelse']}', 
 epost = '{$_POST['epost']}', betalt = '{$_POST['betalt']}' WHERE loparid = {$loparid}"); 
