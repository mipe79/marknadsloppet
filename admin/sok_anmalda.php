...
include "../include/conn.php"; // Databasanslutningen 
    ...
    $query = mysql_query("SELECT * FROM $anmalda WHERE loparid LIKE '$varde' ORDER BY loparid DESC LIMIT 0, 20");
...
<tr>
  ...
  <td><a href="andra_anmalda.php?id=<?=$id?>"><?=$fnamn?>&nbsp<?=$enamn?></a></td>
