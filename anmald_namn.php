...
include "include/conn.php"; // Databasanslutningen 
   ...
   if ($fnamn == "*" && $enamn == "*")
   {
    $query = mysql_query("SELECT * FROM $anmalda ORDER BY fnamn");
...
<?   
   ...
   elseif($fnamn == "*")
     {
     $query = mysql_query("SELECT * FROM $anmalda WHERE enamn LIKE '$enamn' ORDER BY enamn");
	while($a = mysql_fetch_array($query))
	 {
	   $startnr = $a["startnr"];
       $fnamn = $a["fnamn"];
...
<?
    ...
    elseif($enamn == "*")
    {
    $query = mysql_query("SELECT * FROM $anmalda WHERE fnamn LIKE '$fnamn' ORDER BY fnamn");
	while($a = mysql_fetch_array($query))
	 {
	   $startnr = $a["startnr"];
       $fnamn = $a["fnamn"];
...
<?
    ...
    {
    $query = mysql_query("SELECT * FROM $anmalda WHERE fnamn LIKE '$fnamn' AND enamn LIKE '$enamn' ORDER BY fnamn");
	while($a = mysql_fetch_array($query))
	 {
	    $startnr = $a["startnr"];
	    $fnamn = $a["fnamn"];
