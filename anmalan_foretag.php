...
mysql_query("INSERT INTO $anmalda (loparid, fnamn, enamn, adress, postnummer, ort, land, forening, fodelse, klass, lag_foretag, avgift, starttid, antal, epost, betalt, datum, tid) VALUES ('$id1', '$fnamn1', '$enamn1', '$adress', '$postnummer', '$ort', '$land', '$forening', '$fodelse1', '$klass1', '$lag_foretag', '$avgift', '$starttid1', '$antal1', '$epost', 'nej', NOW(), NOW())");

sleep(1);

mysql_query("INSERT INTO $anmalda (loparid, fnamn, enamn, adress, postnummer, ort, land, forening, fodelse, klass, lag_foretag, avgift, starttid, antal, epost, betalt, datum, tid) VALUES ('$id2', '$fnamn2', '$enamn2', '$adress', '$postnummer', '$ort', '$land', '$forening', '$fodelse2', '$klass2', '$lag_foretag', '$avgift', '$starttid2', '$antal2', '$epost', 'nej', NOW(), NOW())");

sleep(1);

mysql_query("INSERT INTO $anmalda (loparid, fnamn, enamn, adress, postnummer, ort, land, forening, fodelse, klass, lag_foretag, avgift, starttid, antal, epost, betalt, datum, tid) VALUES ('$id3', '$fnamn3', '$enamn3', '$adress', '$postnummer', '$ort', '$land', '$forening', '$fodelse3', '$klass3', '$lag_foretag', '$avgift', '$starttid3', '$antal3', '$epost', 'nej', NOW(), NOW())"); 
...
<tr>
  <td WIDTH="340">
    ...
    <tr>
         ...
         <td><input TYPE="Text" NAME="avgift" SIZE="4" MAXLENGTH="4" VALUE="300" readonly> kr</td>
   </tr>
